...
def nuevo_contacto():
    if request.method == 'POST':
        ...
        nuevo = Contacto(nombre=nombre, telefono=telefono, correo=correo , lugar=lugar, fecha=fecha, motivo=motivo, hora=hora)
...
def editar_contacto(id):
    ...
    if request.method == 'POST':
        ...
        contacto.lugar = request.form['lugar']
        contacto.fecha = request.form['fecha']
        contacto.motivo = request.form['motivo']
        contacto.hora = request.form['hora']
        db.session.commit()
        return redirect(url_for('contactos.listar_contactos'))
